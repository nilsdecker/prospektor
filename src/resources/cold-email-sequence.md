...
date: 2026-08-18
readingTime: 7
ogImage: /assets/img/og/cold-email-sequence.png
---
...
> with their current tool is **A** and **B**. Which of those is for you?

Expect roughly **zero replies**. That is the design, not a failure. This email is
doing two jobs: it lands two specific problems in their head in the customer's own
...
The structure inverts the usual sequence's logic. A normal sequence asks for a
meeting five times and hopes one lands. This one **spends three emails being useful
and asks once.**
...
3. **It fails gracefully.** If they never reply, you have still put two well-framed
   problems and two useful resources in front of a qualified person. That is a brand
   impression, not a wasted send.

## The ten-day multi-channel version

Thompson's expanded sequence runs across channels over about ten business days:
...
## Two numbers to change what you do on calls

**Mention price on the first call: 40% close rate versus 28%.**

That is a large difference for a change that costs nothing. The instinct is to
defer price until value is established. The data says the deferral reads as
evasion, and it wastes cycles on people who were never going to clear the number.
If your pricing is public, say it early and let the unqualified self-select out.
...
1. **Twenty minutes:** write down the ten core objections you hear again and again.
   *It's too expensive. We don't have time. We already have something like this. It
   doesn't do X.* There are ten to twenty of these, not thousands.
2. **Ten to fifteen minutes:** write an answer to each, **two to three sentences
   maximum**. Do not try to make them perfect.
3. Send the document to five customers and five people you respect, and ask what is
   wrong with it.

Why the length cap: *a long answer signals to the buyer that the objection is a real
problem; a short, confident one signals expertise.* Unwritten answers vary with your
mood and always run long, because thinking while talking expands.
...
- [ ] Two problems, in the customer's words, sourced from real calls
- [ ] Email 1 short enough to read on a lock screen, ending in a question
- [ ] Two resources that are useful to someone who never buys
- [ ] One ask, in email 4, not before
- [ ] A screen recording of *their* site somewhere in the sequence
- [ ] Price mentioned on call one
- [ ] The objection document written, capped at three sentences per answer
- [ ] A list you can defend before you touch the copy again
