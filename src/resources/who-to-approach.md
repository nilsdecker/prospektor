...
topic: targeting
learnings: activated-not-could-want, the-free-test, already-staffed, lost-to-whom, nobody-takes-a-meeting, in-house-objection
date: 2026-08-23
readingTime: 7
ogImage: /assets/img/og/who-to-approach.png
---
...
The usual diagnosis is that the pitch needs work. Usually it doesn't. Here is
Jason Cohen describing the actual mechanism, in a teardown of a company with
...
That is a different question, it is answerable from public information, and
almost nobody scores for it.

## What activation actually looks like from outside

You cannot see someone's OKRs. You can see the artefacts of them, and they are
surprisingly legible:

- **A recent hire into the owning role.** Somebody hired a Head of Partnerships
  eleven weeks ago. That person has a first-quarter plan and needs it to work.
  This is the single strongest activation signal available publicly, and it has a
  short half-life.
- **An announced push into a new market or segment.** A launch page, a press note,
  a careers page suddenly listing three roles in one region. Someone owns that
  announcement.
- **A competitor's move they have to answer.** If their nearest rival shipped the
...
When a deal dies, there is one forensic question worth asking, and most teams
...
The uncomfortable implication is that a well-written email to an unactivated buyer
performs about as well as a badly written one, and both look like a copywriting
problem. They are a targeting problem wearing a copywriting costume.
